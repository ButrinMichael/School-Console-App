...
public class StudentServiceImplTest {
	...
	void getCoursesByStudentName_shouldReturnCourses_whenStudentExists() {
		...
		when(studentRepository.findWithCoursesByFirstNameAndLastName("John", "Doe")).thenReturn(Optional.of(student));
	...
	void findStudentsByCourseName_shouldDelegateToRepository() {
		...
		when(studentRepository.findStudentsByCourseName("Math")).thenReturn(students);
