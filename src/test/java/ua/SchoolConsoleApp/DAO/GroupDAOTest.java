...
public class GroupDAOTest {
	...
	public void read_shouldReturnResult_whenGroupFound() {
	    ...
	    Optional<Group> result = groupDAOld.read(1);
	...
	public void getAll_schouldReturnGroupList() {
	    ...
	    List<Group> result = groupDAOld.getAll();
